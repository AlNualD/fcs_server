...
public class DND5Controller {
    ...
    public ResponseEntity<List<Attribute>> getAttributesEn() {
        return new  ResponseEntity<List<Attribute>>(attributesService.getBasicAttributesDnd5Eng(),HttpStatus.OK);
    }
    @GetMapping("/dnd5/attributes/ru/basic")
    public ResponseEntity<List<Attribute>> getAttributesRu() {
        return new  ResponseEntity<List<Attribute>>(attributesService.getBasicAttributesDnd5Rus(),HttpStatus.OK);
    }
